...
export const metadata: Metadata = {
  title: "Mahadev Book ID | Get Your Cricket Gaming ID Instantly",
  description: "Apply for your Mahadev Book ID today and enjoy instant account activation, live cricket gaming, IPL gaming, casino games, and quick withdrawals.",
  alternates: {
