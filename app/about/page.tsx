...
export const metadata: Metadata = {
  title: "About Mahadev Bookie | Trusted Online Gaming Platform",
  description: "Learn about Mahadev Bookie, our mission, secure gaming platform, and why thousands of users trust us for cricket gaming, casino and sports gaming.",
  alternates: {
    canonical: "/about/",
  }
};
