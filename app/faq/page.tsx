...
export const metadata: Metadata = {
  title: "Mahadev Bookie FAQs | Gaming ID, Registration & Support",
  description: "Find answers to frequently asked questions about Mahadev Bookie accounts, gaming IDs, deposits, withdrawals, sports, and casino gaming.",
  alternates: {
    canonical: "/faq/",
  }
};
...
const fullFaqs = [
  {
    ...
    a: "The Mahadev Book Online Gaming ID is a verified account that lets you access gaming services such as cricket, casino, poker, and more. With this ID, users can deposit funds, place bets, and enjoy a secure gaming experience."
  },
  {
